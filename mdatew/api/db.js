...
const KeySchema = new mongoose.Schema({
  ...
  key: String, name: String, userId: String, email: String, isAdmin: {
type:Boolean, default:false}
, adminCode: String, boundFingerprints: [String], createdAt: {
...
const EntrySchema = new mongoose.Schema({
  ...
  keyId: String, userId: String, title: String, content: String, month: Number, year: Number, createdAt: {
type:Date, default:Date.now}
, imagePath: String
}
);
